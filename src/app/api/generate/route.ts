...
* **実績・数字の具体化**:
  ...
  * 事実に基づかない数値は絶対に使用しないこと。具体的な数値が不明な場合は数値を使わず定性的に表現すること。
...
4. **実績は数字で証明**
   ...
   - 事実に基づかない数値は絶対に使用しないこと。具体的な数値が不明な場合は定性的に表現すること
...
3. **実績は提供データのみで証明**
   - 事実に基づかない数値・社名は絶対に使用しないこと
   - 具体的な数値が不明な場合は定性的に表現すること
...
3. **実績は提供データのみで証明（事実に基づかない数値・社名は絶対に使用しないこと）**
...
3. **実績は数字で証明**
   ...
   - 事実に基づかない数値・社名は絶対に使用しないこと。具体的な数値が不明な場合は定性的に表現すること
