              ...
              <>
                {user ? (
                  <>
                    ...
                    <Link
                      href="/new"
                      className="md:hidden px-3 py-1.5 bg-amber-800 text-white rounded-md font-bold text-xs hover:bg-amber-900 transition-colors shadow-sm flex items-center gap-1"
                    >
                    ...
                    <nav className="hidden md:flex items-center gap-4">
                      ...
                      <Link
                        href="/new"
                        className="px-4 py-2 bg-amber-800 text-white rounded-md font-bold text-sm hover:bg-amber-900 transition-colors shadow-sm flex items-center gap-1.5"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                        </svg>
